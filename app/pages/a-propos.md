...
<div class="row g-3 align-items-center mb-5">
	<div class="col-lg-5 col-xxl-6 position-relative">
		<h1 class="fs-3 lh-base fw-bold text-primary">
...
<div class="row g-3">
    <div class="col-sm-6 col-lg-4 d-flex justify-content-center align-items-center">
        <h1 class="fs-3 lh-base fw-bold text-primary">Quelques avantages de l'utilisation Venone ?</h1>
    </div>
    <div class="col-sm-6 col-lg-4">
        <div class="card card-body bg-light p-4 h-100">
            ...
            <h1 class="fs-5 mb-2">Gain de temps et d'argent</h1>
            <p>
    ...
    <div class="col-sm-6 col-lg-4">
        <div class="card card-body bg-light p-4 h-100">
            ...
            <h1 class="fs-6 mb-2">Accessibilité</h1>
            <p class="mb-0">
                Venone est une plateforme flexible et pratique qui permet aux utilisateurs de gérer leur patrimoine et leurs finances à tout moment et depuis n'importe quel appareil connecté, offrant ainsi une plus grande flexibilité dans la gestion de leurs tâches de gestion immobilière et un confort supplémentaire.
            </p>
        </div>
    </div>
    <div class="col-sm-6 col-lg-4">
        <div class="card card-body bg-light p-4 h-100">
            ...
            <h1 class="fs-6 mb-2">Sécurité</h1>
            <p class="mb-0">
                Venone est une application de gestion immobilière qui utilise des mesures de sécurité avancées pour protéger les informations personnelles et financières de ses utilisateurs, ce qui garantit la sécurité des données contre les cyberattaques et autres menaces potentielles.
            </p>
        </div>
    </div>
</div>
<div class="row align-items-center g-3 py-3">
    <div class="col-sm-8 col-xl-8">
        ...
        <p>Venone est une application de gestion immobilière qui assure la sécurité de vos informations personnelles et financières en utilisant des mesures de sécurité avancées.</p>
    </div>
    <div class="col-sm-4 col-xl-4">
        <div class="card card-body shadow-none h-100">
            <div class="d-flex justify-content-center align-items-center">
                <img src="../static/img/element/operators.webp" class="h-200px w-280px" alt="venone-money">
            </div>
        </div>
    </div>
</div>
